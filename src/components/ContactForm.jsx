...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(
        "Ocurrió un error al enviar tu consulta. Intentá nuevamente.",
      );
    } finally {
      setIsSending(false);
    }
  ...
  return (
    <div className="w-full">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
        Dejanos tu consulta, a la brevedad nos contactaremos.
      </h2>
      ...
      <form onSubmit={handleSubmit} className="w-full space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            value={form.mensaje}
            onChange={handleChange}
            placeholder="Escribí tu consulta acá e indicá qué obra social o prepaga tenés..."
            className={inputClass}
            disabled={isSending}
            required
          />
